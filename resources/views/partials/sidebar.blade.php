<aside id="hs-pro-sidebar" class="hs-overlay [--auto-close:lg]
  ...
  dark:bg-neutral-800 dark:border-neutral-700" tabindex="-1" aria-label="Sidebar">
    <div class="relative flex flex-col h-full max-h-full pt-3">
        <header class="h-[46px] ps-5 pe-2 lg:ps-8 flex items-center gap-x-1">
            <!-- Logo -->
            <a class="flex-none rounded-md text-xl inline-block font-semibold focus:outline-none focus:opacity-80" href="{{route('links.index')}}" aria-label="QR Code">
            ...
            <nav class="hs-accordion-group pb-3  w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
                <ul class="flex flex-col gap-y-1">
                    ...
                    <li class="px-2 lg:px-5">
                        <a class="{{ Request::is('profile') || Request::is('profile/*') ? 'bg-gray-100' : '' }} flex gap-x-3 py-2 px-3 text-sm text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:text-neutral-300 dark:focus:bg-neutral-700 dark:bg-neutral-700" href="{{route('profile.edit')}}">
                    ...
                    <!--   Links   -->
                    <li class="px-2 lg:px-5">
                        <a class="{{ Request::is('links') || Request::is('links/*') ? 'bg-gray-100' : '' }} flex gap-x-3 py-2 px-3 text-sm text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:text-neutral-300 dark:focus:bg-neutral-700 dark:bg-neutral-700" href="{{route('links.index')}}">
                            <svg class="shrink-0 mt-0.5 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" ><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
                            Liens
                        </a>
                    </li>
                    ...
                    <!--   QR Code   -->
                    <li class="px-2 lg:px-5">
                        <a class="{{ Request::is('qrcode') || Request::is('qrcode/*') ? 'bg-gray-100' : '' }} flex gap-x-3 py-2 px-3 text-sm text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:text-neutral-300 dark:focus:bg-neutral-700 dark:bg-neutral-700" href="{{route('qrcode.index')}}">
                            <svg class="shrink-0 mt-0.5 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" ><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
                            Mon QR Code
                        </a>
                    </li>
                    ...
                    <!--   QR Code   -->
                    <li class="px-2 lg:px-5">
                        <a class="{{ Request::is('customize') || Request::is('customize/*') ? 'bg-gray-100' : '' }} flex gap-x-3 py-2 px-3 text-sm text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:text-neutral-300 dark:focus:bg-neutral-700 dark:bg-neutral-700" href="{{route('users.customize')}}">
                            <svg class="shrink-0 mt-0.5 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" ><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
                            Personnalisation
                        </a>
                    </li>
